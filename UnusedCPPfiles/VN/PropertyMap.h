...
#ifndef _SMESHLIB_PROPERTYMAP_H_
#define _SMESHLIB_PROPERTYMAP_H_
...
// In SMeshLib, PropertyMap class is used to associate properties to vertex, 
// halfedge, and facet.
...
#endif // _SMESHLIB_PROPERTYMAP_H_
