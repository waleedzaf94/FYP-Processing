...
void PolyhedronBuilder::ToModelInfo(Polyhedron_3 & P, ModelBuilder::modelInfo & model)
{
...
void PolyhedronBuilder::ToPwnVector(Polyhedron_3 & P, Pwn_vector & points) {
...
template<class T>
void PolyhedronBuilder::PrintInfo(T & P)
{
